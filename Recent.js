        ...
        return (
            ...
            <View>
                ...
                <TouchableOpacity
                    ...
                    <View style = {{marginLeft :30 ,marginRight:10,marginTop:2, marginBottom:20,width:40,
                        backgroundColor:'white',padding:5}}>
                        <Image style = {{width :60 ,height : 60 ,borderRadius:30 }}
                               source={{uri: item.item.second_user_image}}/>
                        <Text style = {{fontSize: 11,marginBottom:2,textAlign:'center',width:100,marginLeft:-20, height:'auto'}}>
        ...
        return (
            ...
            <View>
                ...
                <TouchableOpacity
                    ...
                    <View style = {{marginLeft :30 ,marginRight:10,marginTop:2, marginBottom:20,width:60,
                        backgroundColor:'white',padding:5}}>
                        <Image style = {{width :60 ,height : 60 ,borderRadius:30 }}
            ...
            <View >
                ...
                <View style={{ flex:1}}>
                    ...
                    <SlidingUpPanel ref={c => this._panel = c}>
                        <View style={{backgroundColor :'white',borderRadius:20,width:window.width - 20 ,marginLeft:10,height:window.height - 120,marginTop :80}}>
                            ...
                            <Image style = {{width :window.width - 20 ,height : 190,resizeMode:'stretch' }}
                                   source={{uri :this.state.news_description.image}}/>


                                <View style = {{backgroundColor:'rgba(0, 0, 0, 0.3)',marginTop:-190,height:190}}>
                                </View>


                            <Text style={{color:'white',fontSize:18,margin:10 ,marginTop: - 60 }}>{this.state.news_description.news_title}</Text>

                            <Text style={{color:'grey',fontSize:13,marginLeft:10,marginTop:10, marginBottom:10 }}>SHARE WITH GROUPS</Text>
                            ...
                            <Text style={{color:'grey',fontSize:13,marginLeft:10,marginTop:10, marginBottom:10 }}>SHARE WITH USERS</Text>
